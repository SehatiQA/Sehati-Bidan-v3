...
Mobile.setText(findTestObject('Object Repository/ProfilBidan/field_nama'), 'a', 0)

Mobile.verifyElementExist(findTestObject('Object Repository/ProfilBidan/error_namaKurangdari2karakter'), 0)
