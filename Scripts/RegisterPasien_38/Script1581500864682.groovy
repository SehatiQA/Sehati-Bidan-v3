...
Mobile.verifyElementExist(findTestObject('Registrasi Pasien/title_PendaftaranIbu'), 0)
...
Mobile.tap(findTestObject('Registrasi Pasien/field_tglLahir'), 0)
...
Mobile.setText(findTestObject('Registrasi Pasien/cari/field_cariProvinsi'), 'Barat', 0)

Mobile.delay(1)

Mobile.tap(findTestObject('Registrasi Pasien/cari/result_1'), 0)

Mobile.delay(1)

Mobile.tap(findTestObject('Registrasi Pasien/field_Kota'), 0)

Mobile.setText(findTestObject('Registrasi Pasien/cari/field_cariProvinsi'), 'Depok', 0)

Mobile.tap(findTestObject('Registrasi Pasien/cari/result_1'), 0)

Mobile.verifyElementExist(findTestObject('Registrasi Pasien/button_selanjutnya'), 0)

Mobile.tap(findTestObject('Registrasi Pasien/button_selanjutnya'), 0)

Mobile.delay(1)

Mobile.tap(findTestObject('Registrasi Pasien/button_tambahpasienbaru'), 0)

Mobile.delay(1)

Mobile.setText(findTestObject('Registrasi Pasien/field_phonenumber'), '081234567', 0)

Mobile.verifyElementExist(findTestObject('Registrasi Pasien/errorhandling/error_nohp_less10'), 0)