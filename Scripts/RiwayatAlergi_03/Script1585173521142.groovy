...
Mobile.verifyElementText(findTestObject('Object Repository/Riwayat Alergi/field_alergiObat'), randomString)

Mobile.verifyElementText(findTestObject('Object Repository/Riwayat Alergi/field_alergiMakanan'), randomString)

Mobile.verifyElementText(findTestObject('Object Repository/Riwayat Alergi/field_alergiLainnya'), randomString)