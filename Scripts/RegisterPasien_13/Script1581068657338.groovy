...
Mobile.setText(findTestObject('Registrasi Pasien/field_noKTP'), '12345678912345678', 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Registrasi Pasien/errorhandling/error_KTP_more16'), 0)
