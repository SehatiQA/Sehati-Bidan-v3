...
//sistol
Mobile.setText(findTestObject('ANC/Antropometri/field3'), '101', 0)

//diastol
Mobile.setText(findTestObject('ANC/Antropometri/field4'), '40', 0)

//suhu
Mobile.setText(findTestObject('ANC/Antropometri/field5'), '40', 0)
...
Mobile.tap(findTestObject('Object Repository/ANC/Obstetri/abdoment/opt_balotement_tidakteraba'), 0)
