...
Mobile.setText(findTestObject('Object Repository/List Pasien/field_searchPasiens'), 'Automation TFU', 0)
...
Mobile.tap(findTestObject('Object Repository/ANC/Obstetri/abdoment/opt_TFU'), 0)

//isi field TFU
Mobile.setText(findTestObject('Object Repository/ANC/Obstetri/field_1'), '33', 0)

//pilih leopold
Mobile.tap(findTestObject('Object Repository/ANC/Obstetri/radio_Tunggal'), 0)

//tap letak janin
Mobile.tap(findTestObject('Object Repository/ANC/Obstetri/field_2'), 0)

Mobile.tap(findTestObject('Object Repository/ANC/Obstetri/Letak Janin/opt_lintang'), 0)

//set TBJ
Mobile.setText(findTestObject('Object Repository/ANC/Obstetri/field_3'), '3232', 0)

Mobile.scrollToText('BATAL')

//set DJJ
Mobile.setText(findTestObject('Object Repository/ANC/Obstetri/field_2'), '32', 0)
