...
Mobile.verifyElementNotExist(findTestObject('Object Repository/INC/Observasi/option_incObservasi_30min'), 0)
...
Mobile.tap(findTestObject('Object Repository/Home/NavDrawer - Beranda'), 0)
