...
Mobile.tap(findTestObject('Object Repository/Welcome Screen/buttomsheet_wa_tdk_ada/button_x'), 0)

Mobile.verifyElementNotExist(findTestObject('Object Repository/Welcome Screen/buttomsheet_wa_tdk_ada/copy_WA_tdk_ada_title'), 0)

Mobile.tap(findTestObject('Object Repository/Welcome Screen/button_saya_mau_daftar'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Welcome Screen/buttomsheet_wa_tdk_ada/copy_WA_tdk_ada_title'), 0)

Mobile.tapAtPosition(750, 1500)
