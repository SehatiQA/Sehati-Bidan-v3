...
Mobile.clearText(findTestObject('Object Repository/ProfilBidan/field_nama'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/ProfilBidan/error_namaTidakBolehKosong'), 0)
