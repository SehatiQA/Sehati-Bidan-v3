...
Mobile.setText(findTestObject('Object Repository/Registrasi Pasien/cari/field_cariProvinsi'), 'Kota Bandung', 0)
...
Mobile.tap(findTestObject('Object Repository/Registrasi Pasien/field_kecamatan'), 0)

Mobile.setText(findTestObject('Object Repository/Registrasi Pasien/cari/field_cariProvinsi'), 'bojong', 0)
...
Mobile.setText(findTestObject('Object Repository/Registrasi Pasien/cari/field_cariProvinsi'), 'kelurahan', 0)

Mobile.tap(findTestObject('Object Repository/Registrasi Pasien/cari/result_1'), 0)

Mobile.delay(1)

a = Mobile.getText(findTestObject('Object Repository/Registrasi Pasien/field_desa'), 0)

Mobile.tap(findTestObject('Object Repository/Registrasi Pasien/field_kecamatan'), 0)

Mobile.setText(findTestObject('Object Repository/Registrasi Pasien/cari/field_cariProvinsi'), 'bojong', 0)

Mobile.tap(findTestObject('Object Repository/Registrasi Pasien/cari/result_2'), 0)

Mobile.delay(1)

b = Mobile.getText(findTestObject('Object Repository/Registrasi Pasien/field_desa'), 0)
