...
Mobile.setText(findTestObject('Object Repository/INC/Observasi/Tanda Vital/field_kontraksiDurasiDetik'), '101', 0)

Mobile.verifyElementExist(findTestObject('Object Repository/INC/Observasi/Error/error_kontraksisecond_more_100'), 0)

Mobile.setText(findTestObject('Object Repository/INC/Observasi/Tanda Vital/field_kontraksiDurasiDetik'), '4', 0)